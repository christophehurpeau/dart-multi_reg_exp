...
dartanalyzer lib/multi_reg_exp.dart || exit 1
...
echo "\n> Generate docs"
dartdoc lib/multi_reg_exp.dart --package-root=packages
...
git remote set-url origin git@github.com:christophehurpeau/dart-multi_reg_exp.git
